    ...
    <header className="header">
      <div className="header-container">
        ...
        <div className="header-icons">
          <span className="icon-img" aria-label="Account" style={{backgroundImage: 'url(/image/Vectors.png)', backgroundSize: 'contain', backgroundPosition: 'center', backgroundRepeat: 'no-repeat'}} />
